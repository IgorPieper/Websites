                    ...
                    <div class='col-sm-12 mr-1 mt-1'>
                        ...
                        <?php
                            ...
                            if(isset($_SESSION["koszyk"])) {
                                foreach ($_SESSION["koszyk"] as $x) {
                                    $sql = "SELECT id, nazwa, cena FROM kamien WHERE id=" . $x;
                                    ...
                                    if ($wynik > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            foreach ($_SESSION["koszyk"] as $x){
                                                ...
                                                echo "<tr>";
                                                echo "<th scope='row'>" . $liczba . "</th>";
                                                echo "<td>" . $row["nazwa"] . "</td>";

                                                echo "<td><form method='post' action='koszyk.php?id=" . $row["id"] . "'>";
                                                echo "<button type='submit'>";
                                                    echo "<img src='grafiki/dodaj.png' style='width: 20px; height: 20px'>";
                                                echo "</button></form></td>";

                                                echo "<td>" . $row["cena"] . " zł</td>";

                                                echo "<td><form method='post' action='usun_z_kosza.php?id=" . $row["id"] . "'>";
                                                echo "<button type='submit'>";
                                                    echo "<img src='grafiki/trash.png' style='width: 20px; height: 20px'>";
                                                echo "</button></form></td>";
                        ...
                        <div style="float: right">
                            <form action="dostawa.php" method="post">
                                <input type="submit" value="Przejdź do Formularza">
                            </form>
                        </div>
                    </div>
                </div>
